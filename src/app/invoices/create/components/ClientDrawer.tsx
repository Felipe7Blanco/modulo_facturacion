...
export function ClientDrawer({ isOpen, onClose, onSelectClient }: ClientDrawerProps) {
    const [formData, setFormData] = useState({
        personType: 'juridica', // juridica o natural
        idType: 'NIT',
        nit: '',
        businessName: '',
        tradeName: '',
                    ...
                    <Stack gap={4}>
                        ...
                        <Box>
                            ...
                            <Flex gap={3}>
                                <Button
                                    flex={1}
                                    variant={formData.personType === 'juridica' ? 'solid' : 'outline'}
                                    colorScheme={formData.personType === 'juridica' ? 'blue' : 'gray'}
                                ...
                                <Button
                                    flex={1}
                                    variant={formData.personType === 'natural' ? 'solid' : 'outline'}
                                    colorScheme={formData.personType === 'natural' ? 'blue' : 'gray'}
                        ...
                        <Box>
                            ...
                            <Flex gap={2}>
                                ...
                                <Button
                                    ...
                                    onClick={() => console.log('Consultar DIAN')}
                                >
                                    Consultar DIAN
                                </Button>
                            </Flex>
                        ...
                        <Box>
                            <Text fontSize="sm" fontWeight="600" mb={2} color="gray.700">
                                {formData.personType === 'juridica' ? 'Nombre Empresa' : 'Nombre Completo'} *
                            </Text>
                            <Input
                                placeholder={formData.personType === 'juridica' ? 'Ej: Empresa S.A.S.' : 'Ej: Juan Pérez'}
                        ...
                        <Box>
                            ...
                            <select
                                value={formData.ivaResponsibility}
                                onChange={(e) => handleChange('ivaResponsibility', e.target.value)}
                                style={{
                                    width: '100%',
                                    padding: '8px 12px',
                                    fontSize: '14px',
                        ...
                        <Box>
                            ...
                            <select
                                value={formData.fiscalResponsibilities}
                                onChange={(e) => handleChange('fiscalResponsibilities', e.target.value)}
                                style={{
                                    width: '100%',
                                    padding: '8px 12px',
                                    fontSize: '14px',
