                ...
                <Table.Root size="sm" variant="outline">
                    <Table.Header>
                        <Table.Row bg="gray.100">
                            <Table.ColumnHeader w="50px" textAlign="center">REF</Table.ColumnHeader>
                            <Table.ColumnHeader minW="300px">Descripción del Producto / Servicio</Table.ColumnHeader>
...
// --- SUBCOMPONENTE DE FILA PARA MANEJAR ESTADO INDIVIDUAL ---
function ItemRow({ item, index, onUpdateItem, onRemoveItem }: any) {
    ...
    return (
        <Table.Row _hover={{ bg: 'gray.50' }}>
            ...
            {/* COLUMNA MAGICA: PRODUCTO / SERVICIO */}
            <Table.Cell>
            ...
            <Table.Cell>
                <IconButton 
                    size="xs" variant="ghost" colorPalette="red" aria-label="Borrar"
